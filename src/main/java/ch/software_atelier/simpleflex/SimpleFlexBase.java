...
public class SimpleFlexBase {
    ...
    private void logBanner() {
        LOG.info("\n __ _                 _       __ _           \n"
                + "/ _(_)_ __ ___  _ __ | | ___ / _| | _____  __\n"
                + "\\ \\| | '_ ` _ \\| '_ \\| |/ _ \\ |_| |/ _ \\ \\/ /\n"
                + "_\\ \\ | | | | | | |_) | |  __/  _| |  __/>  < \n"
                + "\\__/_|_| |_| |_| .__/|_|\\___|_| |_|\\___/_/\\_\\\n"
                + "               |_|                           \n"
                + SERVER_VERS);
    }
            ...
            for (File f : files) {
                if (f.isFile() && !f.isHidden()) {
                    try {
                        ...
                        LOG.error("failed to load Library " + f.getPath() + ":" + ioe.getMessage());
                    }
                }
            }
        }
    ...
    private static void simple() {
        ...
        WebAppConfig wac = new WebAppConfig(DefaultApp.class.getName(), "DEFAULT");
